...
class ScoringService(object):
    ...
    @classmethod
    def rsi(cls, close: pd.DataFrame, period: int = 14) -> pd.Series:
    ...
    @classmethod
    def macd(cls, close : pd.DataFrame, span1=12, span2=26):
    ...
    def price_fe(cls, feats):
        ...
        # RSI
        rsi = cls.rsi(feats["EndOfDayQuote ExchangeOfficialClose"], 14)
        feats['RSI'] = rsi.values

        # MACD
        macd, exp3 = cls.macd(feats["EndOfDayQuote ExchangeOfficialClose"], 12, 26)
